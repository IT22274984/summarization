...
with st.sidebar.expander("More About Summarization"):
    ...
    Abstractive summarization, on the other hand, involves the model understanding the context and generating a summary with new phrases and language. It is more similar to how humans summarize content.
    """)
